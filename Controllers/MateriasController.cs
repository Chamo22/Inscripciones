...
namespace Inscripcioness.Controllers
{
    public class MateriasController : Controller
    {
        ...
        {
            ViewData["AnioCarreraId"] = new SelectList(_context.aniosCarreras, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,AnioCarreraId")] Materia materia)
        {
            ...
            ViewData["AnioCarreraId"] = new SelectList(_context.aniosCarreras, "Id", "Id", materia.AnioCarreraId);
            return View(materia);
        }
