...
namespace Inscripcioness.Controllers
{
    ...
    [ApiController]
    public class ApiInscripcionsController : ControllerBase
    {
        private readonly InscripcionesContext _context;

        public ApiInscripcionsController(InscripcionesContext context)
        {
            _context = context;
        }

        // GET: api/ApiInscripcions
        [HttpGet]
